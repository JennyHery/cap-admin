                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row">
                        <div class="col-lg-12 mb-4 order-0">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?= form_open('classe/enregistrer') ?>
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-default-fullname">Classe</label>
                                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Inserer la classe" name="classe_nom" />
                                        <?php echo form_error('classe_nom'); ?>  
                                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php for($i = 0; $i < count($classe); $i++): ?>
                                        <tr>
                                            <td><?= $classe[$i]->classe_nom ?></td>
                                            <td>
                                                <a class="badge bg-label-info me-1" href="" data-bs-toggle="modal" data-bs-target="#basicModal<?= $classe[$i]->classe_id ?>">Modifier</a>
                                                <a class="badge bg-label-danger me-1" href="<?= base_url() ?>Classe/supprimer/<?= $classe[$i]->classe_id ;?>">Supprimer</a>
                                            </td>
                                        </tr>


                                        <div class="modal fade" id="basicModal<?= $classe[$i]->classe_id ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open('Classe/modifier/'.$classe[$i]->classe_id) ?>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="classe" class="form-label">Classe</label>
                                                                <input type="text" id="classe" class="form-control" placeholder="Inserer la classe" name="classe_nom" value="<?= $classe[$i]->classe_nom ;?>" />
                                                            </div>
                                                        </div>
                                                    </div>
